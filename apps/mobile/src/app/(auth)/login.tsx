...
const styles = StyleSheet.create({
  ...
  top: { flexDirection: "row", alignItems: "center", gap: 10, paddingTop: 8 }, back: { width: 44, height: 44, alignItems: "center", justifyContent: "center", marginLeft: -10 }, brand: { flexDirection: "row", gap: 8, alignItems: "center" }, brandIcon: { width: 28, height: 28, borderRadius: 14 }, brandText: { color: Colors.white, fontFamily: "Inter-Bold", fontSize: 18 },
