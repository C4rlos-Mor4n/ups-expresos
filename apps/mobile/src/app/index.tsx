...
const styles = StyleSheet.create({
  ...
  brand: { flexDirection: "row", alignItems: "center", gap: 10, paddingTop: 8 }, mark: { width: 48, height: 48, borderRadius: 24, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0, 28, 67, 0.78)" }, brandText: { color: Colors.white, fontFamily: "Inter-Bold", fontSize: 20, letterSpacing: 0.4 },
