      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>
            El transporte universitario, claro y a tiempo.
          </Text>
          <Text style={styles.subtitle}>
            Consulta tu servicio programado o gestiona tu jornada desde un solo
            lugar.
          </Text>
        </View>
        <Pressable
          accessibilityRole="button"
          accessibilityLabel="Ingresar a UPS GO"
          style={({ pressed }) => [
            styles.button,
        ...
        >
          <Text style={styles.buttonText}>Ingresar a UPS GO</Text>
...
const styles = StyleSheet.create({
  ...
  overlay: {
    ...
    backgroundColor: "rgba(0, 33, 82, 0.42)",
  },
  ...
  buttonText: { color: Colors.navy, fontFamily: "Inter-Bold", fontSize: 16 },
});
